...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Editar Venta</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container my-4">
        <h2 class="mb-4">Editar Venta ID: <?php echo htmlspecialchars($venta['id']); ?></h2>
        ...
        <div class="card">
            <div class="card-body">
                <form id="ventaForm" action="editar.php?id=<?php echo $id_venta; ?>" method="POST">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_cliente" name="id_cliente" required>
                            ...
                            <?php foreach ($clientes as $cliente): ?>
                                <option value="<?php echo htmlspecialchars($cliente['id']); ?>"
                                    <?php echo ($cliente['id'] == $venta['id_cliente']) ? 'selected' : ''; ?>>
                    ...
                    <div class="row mb-3 align-items-end">
                        <div class="col-md-6">
                            <label for="producto_selector" class="form-label">Añadir o Modificar Producto</label>
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-info w-100" id="add_product_btn"><i class="bi bi-plus-circle"></i> Añadir/Actualizar</button>
                        </div>
                    </div>
    ...
    <script>
        let selectedProducts = <?php echo $initial_selected_products_json; ?>; // {producto_id: {nombre, precio_unitario, cantidad, stock_original}}
