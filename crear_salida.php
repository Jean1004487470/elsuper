...
<body>
    ...
    <div class="container my-4">
        <h2 class="mb-4">Registrar Salida de Inventario</h2>
        ...
        <div class="card">
            <div class="card-body">
                <form action="crear_salida.php" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="cantidad" class="form-label">Cantidad de Salida <span class="text-danger">*</span></label>
                    ...
                    <button type="submit" class="btn btn-danger"><i class="bi bi-box-arrow-out-right"></i> Registrar Salida</button>
